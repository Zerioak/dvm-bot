...
class DeployView(discord.ui.View):
    ...
    async def confirm_btn(self, i: discord.Interaction, btn: discord.ui.Button):
        ...
        dm.add_field(name="👤  Username",   value=f"```{rec.get('root', 'root')}```",       inline=True)
...
class PortModal(discord.ui.Modal, title="🔌 Enter Internal Port"):
    ...
    async def on_submit(self, i: discord.Interaction):
        ...
        dm.add_field(name="👤 Username", value=f"```root```", inline=True)
                ...
                try:
                    ...
                    if "error" not in rec:
                        ...
                        try:
                            ...
                            e.add_field(name="👤 Username", value=f"```{rec.get('root', 'root')}```", inline=True)
